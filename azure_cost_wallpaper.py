...
#     try:
#         font_big = ImageFont.truetype("C:\\Windows\\Fonts\\arialbd.ttf", 46)
...
#     # semi-transparent box behind the text so it stays readable on any wallpaper
#     draw.rectangle(
#         [x - 20, y - 15, x + text_w + 20, y + text_h + 60],
#         fill=(0, 0, 0, 160),
#     )
#     draw.text((x, y), main_text, font=font_big, fill=(80, 255, 160))
#     draw.text((x, y + text_h + 10), updated_text, font=font_small, fill=(210, 210, 210))
